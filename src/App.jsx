...
const CURATED_PL_STATIONS = [
  // --- Główne ---
  _pl('rmffm',     'RMF FM',                 'pop,hits,polskie',       128, ['https://rs9-krk2.rmfstream.pl/RMFFM48','https://rs6-krk2.rmfstream.pl/RMFFM48'], 'https://www.rmf.fm/favicon.ico', 'https://www.rmf.fm', 9999),
  _pl('radiozet',  'Radio ZET',              'pop,hits,polskie',       128, ['https://n-4-6.dcs.redcdn.pl/sc/o2/Eurozet/live/audio.livx','https://n-1-6.dcs.redcdn.pl/sc/o2/Eurozet/live/audio.livx'], 'https://www.radiozet.pl/favicon.ico', 'https://www.radiozet.pl', 9998),
  _pl('trojka',    'Polskie Radio Trójka',   'polskie,public,rock',    96,  ['http://stream3.polskieradio.pl:8954/;.mp3','https://mp3.polskieradio.pl:8904/'], 'https://www.polskieradio.pl/favicon.ico', 'https://trojka.polskieradio.pl', 9000),
  _pl('jedynka',   'Polskie Radio Jedynka',  'polskie,public,news',    96,  ['http://mp3.polskieradio.pl:8900/;.mp3','https://mp3.polskieradio.pl:8900/'], 'https://www.polskieradio.pl/favicon.ico', 'https://jedynka.polskieradio.pl', 8900),
  _pl('dwojka',    'Polskie Radio Dwójka',   'polskie,public,classical',96, ['https://stream12.polskieradio.pl/pr2/pr2.sdp/playlist.m3u8','http://mp3.polskieradio.pl:8902/;.mp3'], 'https://www.polskieradio.pl/favicon.ico', 'https://dwojka.polskieradio.pl', 8800),
  _pl('czworka',   'Polskie Radio Czwórka',  'polskie,public,pop',     96,  ['https://stream14.polskieradio.pl/pr4/pr4.sdp/playlist.m3u8','http://mp3.polskieradio.pl:8906/;.mp3'], 'https://www.polskieradio.pl/favicon.ico', 'https://czworka.polskieradio.pl', 8700),
  ...
  _pl('voxfm',     'VOX FM',                 'pop,polskie',            128, ['https://ic2.smcdn.pl/3990-1.mp3'], '', 'https://www.voxfm.pl', 8200),
  // --- RMF podkanały ---
  _pl('rmfclassic',     'RMF Classic',           'classical,polskie',  48, ['http://31.192.216.8/RMFCLASSIC48'], 'https://www.rmfclassic.pl/favicon.ico', 'https://www.rmfclassic.pl', 8600),
  _pl('rmfmaxxx',       'RMF MAXXX',             'dance,polskie',      48, ['https://rs101-krk.rmfstream.pl/RMFMAXXX48'], 'https://www.rmfmaxxx.pl/favicon.ico', 'https://www.rmfmaxxx.pl', 8100),
  _pl('rmf-hiphop',     'RMF Hip Hop',           'hip-hop,rap',        48, ['http://195.150.20.8/HIPHOP'], '', 'https://www.rmf.fm', 6000),
  _pl('rmf-rock',       'RMF Rock',              'rock',               48, ['http://195.150.20.7/ROCK'], '', 'https://www.rmf.fm', 6000),
  _pl('rmf-dance',      'RMF Dance',             'dance,electronic',   48, ['http://31.192.216.10/DANCE'], '', 'https://www.rmf.fm', 6000),
  _pl('rmf-80s',        'RMF 80s',               '80s,retro',          48, ['http://195.150.20.9/80SDISCO'], '', 'https://www.rmf.fm', 5800),
  _pl('rmf-90s',        'RMF 90s',               '90s,retro',          48, ['http://31.192.216.7/90S'], '', 'https://www.rmf.fm', 5800),
  _pl('rmf-gold',       'RMF Gold',              'oldies,polskie',     48, ['http://195.150.20.9/GOLD'], '', 'https://www.rmf.fm', 5700),
  _pl('rmf-chillout',   'RMF Chillout',          'chillout,ambient',   48, ['http://31.192.216.8/CHILLOUT'], '', 'https://www.rmf.fm', 5600),
  _pl('rmf-polskie',    'RMF Polskie Przeboje',  'polskie,pop',        48, ['http://195.150.20.8/PPRZEBOJE'], '', 'https://www.rmf.fm', 5500),
  _pl('rmf-reggae',     'RMF Reggae',            'reggae',             48, ['http://195.150.20.7/REGGAE'], '', 'https://www.rmf.fm', 5400),
  _pl('rmf-blues',      'RMF Blues',             'blues',              48, ['http://31.192.216.10/BLUES'], '', 'https://www.rmf.fm', 5300),
  _pl('rmf-party',      'RMF Party',             'party,dance',        48, ['http://195.150.20.7/PARTY'], '', 'https://www.rmf.fm', 5000),
  // --- ZET podkanały ---
  _pl('zet-dance',      'Zet Dance',             'dance,electronic',  128, ['http://pl01.cdn.eurozet.pl/ZETDAN.mp3'], '', 'https://www.radiozet.pl', 5700),
  _pl('zet-party',      'Zet Party',             'party,hits',        128, ['https://zt02.cdn.eurozet.pl/ZETPAR.mp3'], '', 'https://www.radiozet.pl', 5300),
  _pl('chillizet',      'Chilli ZET',            'pop,hits',          128, ['https://ch.cdn.eurozet.pl/chi-net.mp3'], '', 'https://www.radiozet.pl', 5200),
  _pl('zet-2000',       'Zet 2000',              '2000s,pop',         128, ['https://zt02.cdn.eurozet.pl/ZET200.mp3'], '', 'https://www.radiozet.pl', 5000),
  _pl('zet-soul',       'Zet Soul',              'soul,rnb',          128, ['https://zt02.cdn.eurozet.pl/CHISOU.mp3'], '', 'https://www.radiozet.pl', 4900),
  _pl('zet-kids',       'Zet Kids',              'dzieci',            128, ['https://zt02.cdn.eurozet.pl/ZETKID.mp3'], '', 'https://www.radiozet.pl', 4800),
  // --- Eska ---
  _pl('eskarock',       'Eska Rock',             'rock,polskie',      128, ['https://ic2.smcdn.pl/5380-1.mp3'], '', 'https://www.eskarock.pl', 6000),
  // --- Internetowe / niszowe ---
  ...
  _pl('planetafm',      'Planeta FM',            'dance,clubbing',    128, ['http://pl01.cdn.eurozet.pl/pla-net.mp3'], '', 'https://www.planetafm.pl', 7500),
  _pl('zlotempl',       'Radio Złote Przeboje',  'polskie,oldies',    128, ['http://poznan5-6.radio.pionier.net.pl:8000/tuba9-1.mp3'], '', '', 7000),
  // --- Regionalne ---
  _pl('radiokrakow',    'Radio Kraków',          'polskie,regional',   96, ['http://stream3.nadaje.com:9116/radiokrakow'], '', 'https://www.radiokrakow.pl', 5000),
  _pl('radiolodz',      'Radio Łódź',            'polskie,regional',   96, ['https://stream.radiolodz.toya.cloud/RadioLodz-1.mp3'], '', '', 4900),
  _pl('radiogdansk',    'Radio Gdańsk',          'polskie,regional',   96, ['http://stream.task.gda.pl:8000/rg1'], '', '', 4800),
  _pl('radiopoznan',    'Radio Poznań',          'polskie,regional',   96, ['http://stream4.nadaje.com:8578/poznan'], '', '', 4700),
...
function App() {
  ...
  useEffect(() => {
    ...
    // TV Cast — sync status from Chromecast back to app
    ...
    // TV Cast — skip triggered from TV remote/UI
